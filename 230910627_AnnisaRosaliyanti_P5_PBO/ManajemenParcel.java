...
public final class ManajemenParcel { // final class
    protected static ArrayList<Parcel> daftarParcel = new ArrayList<>();
    static final Scanner scanner = new Scanner(System.in); // final attribute
...
abstract class Parcel {
    ...
    public final String getKategori() { // final method
        return kategori;
    }
    ...
    public abstract String getDeskripsi(); // abstract method
}

// Kelas tambahan sebagai implementasi konkret dari Parcel biasa
